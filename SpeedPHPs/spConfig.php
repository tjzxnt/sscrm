...
return array(
	...
	'auto_load_model' => array('spPager','spValidator','spCache','spLinker'), // 模型自动加载的扩展类名
	...
	'session_name' => null, // SESSION名称设置
	'session_privacy_name' => null, // SESSION权限名称设置
	'none_check_privacy' => array(), // 不在权限检查范围内的C_A设置
	'acl_handle_operators' => '_',//C_A链接操作符
	'home_url' => array(), // 首页地址
	'login_url' => array(), // 登陆页地址
