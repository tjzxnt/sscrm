...
var cnzz_data='&r='+escape(cnzz_ref.substr(0,512))+'&lg='+escape(navigator.systemLanguage)+'&ntime=0.24624900 1315408201';
var cnzz_a=gc_cnzz("cnzz_a1221351");
...
var cnzz_sin = gc_cnzz("sin1221351");
if(cnzz_sin==-1) cnzz_sin='none';
if( cnzz_ref.split('/')[2]!=document.domain ) cnzz_sin=cnzz_ref;
var cnzz_eid=gc_cnzz("cnzz_eid");
if(cnzz_eid==-1) cnzz_eid=Math.floor(Math.random()*100000000)+"-"+1315408201+"-"+cnzz_ref.substr(0,64);
...
document.write('<a href="http://www.cnzz.com/stat/website.php?web_id=1221351" target=_blank title="&#31449;&#38271;&#32479;&#35745;"><img border=0 hspace=0 vspace=0 src="http://icon.cnzz.com/pic.gif" /></a>');
document.write('<img src="http://zs12.cnzz.com/stat.htm?id=1221351'+cnzz_data+'" border=0 width=0 height=0 />');
document.write('<img src="http://hzs12.cnzz.com/stat.htm?id=1221351'+cnzz_data+'" border=0 width=0 height=0 />');
...
document.cookie="cnzz_a1221351="+cnzz_a+";expires="+cnzz_ed.toGMTString()+ "; path=/";
document.cookie="sin1221351="+escape(cnzz_sin)+ ";expires="+cnzz_ed.toGMTString()+";path=/";
