<?php
class vipclientadm extends spController {
	...
	public function clientlist(){
		...
		$this->url = spUrl('vipclientadm', 'clientlist', array("starttime"=>$this->starttime, "endtime"=>$this->endtime, "level_id"=>$this->level_id, "statdate"=>$this->statdate, "channel_id"=>$this->channel_id, "sort"=>$this->sort, "searchkey"=>$this->searchkey, "ispay"=>$this->ispay, "channel_muserid"=>$this->channel_muserid, "user_sales_id"=>$this->user_sales_id, "comactive_id"=>$this->comactive_id));
	}
